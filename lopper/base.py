        ...
        try:
            ...
            if cls.phandle_possible_prop_dict:
                ...
                return {
                    ...
                    "interrupts-extended" : [ 'phandle:#interrupt-cells' ],
                    "iommus" : [ 'phandle:#iommu-cells' ],
                    ...
                    "power-domains" : [ 'phandle:#power-domain-cells' ],
                    "operating-points-v2" : [ 'phandle' ],
                    "next-level-cache" : [ 'phandle' ],
                    "interrupt-affinity" : [ 'phandle' ],
                    "fpga-mgr" : [ 'phandle' ],
                    "memory-region" : [ 'phandle' ],
                    "mboxes" : [ 'phandle:#mbox-cells' ],
                    "dmas" : [ 'phandle:#dma-cells' ],
                    "phys" : [ 'phandle:#phy-cells' ],
                    "thermal-sensors" : [ 'phandle:#thermal-sensor-cells' ],
